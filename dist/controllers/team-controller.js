    ...
    static updateTeam(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const teamIDToUpdate = req.params.team_id;
                const newTeamInfos = req.body;
                const updatedTeam = yield team_service_1.default.updateTeam(loggedUser, newTeamInfos, teamIDToUpdate);
                const response = (0, response_1.default)(true, updatedTeam, null);
                res.status(200).json(response);
            }
            catch (err) {
                const response = (0, response_1.default)(false, null, 'Internal server error.');
